...
public class LibrariesSourceGenerator extends AbstractSourceGenerator {
    ...
    private void writeSingleVersionAccessor(String versionAlias, @Nullable String context, String version, boolean asProvider) throws IOException {
        ...
        if (context != null) {
            writeLn(" * This version was declared in " + escapeBackslashForJavaComment(context));
        }
        writeLn(" */");
    ...
    private void writeDependencyAccessor(String alias, String coordinates, @Nullable String context, boolean asProvider) throws IOException {
        ...
        if (context != null) {
            writeLn("     * This dependency was declared in " + escapeBackslashForJavaComment(context));
        }
        writeLn("     */");
    ...
    private void writeBundle(String alias, List<String> coordinates, @Nullable String context, boolean asProvider) throws IOException {
        indent(() -> {
            ...
            writeLn(" * </ul>");
            if (context != null) {
                writeLn(" * This bundle was declared in " + escapeBackslashForJavaComment(context));
            }
            writeLn(" */");
    ...
    private void writePlugin(String alias, String id, @Nullable String context, boolean asProvider) throws IOException {
        indent(() -> {
            ...
            if (context != null) {
                writeLn(" * This plugin was declared in " + escapeBackslashForJavaComment(context));
            }
            writeLn(" */");
            String methodName = asProvider ? "asProvider" : "get" + toJavaName(leafNodeForAlias(alias));
    ...
    /**
     * Java compiler would fail to compile sources that have illegal unicode escape characters in the comments.
     * Such characters could be accidentally introduced by an unescaped backslash.
     */
    private static String escapeBackslashForJavaComment(String s) {
        return s.replace("\\", "\\\\");
    }
